...
import signal # add signal library
import csv # to write log files
    ...
    while not exit_flag.is_set():
        try:
            ...
            if len(sequence) == sequence_length:
                ...
                log_lable_timestamp(label, time.time(), args.logs)
...
if __name__ == "__main__":
    ...
    if len(slice_size_match) == 2:
        ...
        try:
            # add the map_location since without this parameter it raises an error if CPU is used 
