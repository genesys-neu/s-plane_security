...
#### Example
```
sudo python3 automated_bg_traffic.py -d 1800 
```
This command starts the script in the DU, it connects to the RU and sets the duration experiment for 1800 seconds (30 minutes) .
